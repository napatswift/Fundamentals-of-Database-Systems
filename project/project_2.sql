...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 06:04 PM
...
('0076592', '1100204742237', 'ประตูไม้สนลาว 6 ฟัก โมเดิร์น', 'คำสั่งซื้อกำลังดำเนินการ', '2565-03-06', '2565-03-06', 'โอนเงิน', 'รับที่ร้าน', '1100204742237'),
('0076588', '1100508234563', 'หน้าต่างไม้สัก บันได้ลิง มุมมน ไม้สีเข้ม', 'คำสั่งซื้อสำเร็จ', '2565-02-09', '2565-02-16', 'โอนเงิน', 'รับที่ร้าน', '1100508234563'),
('0076586', '1101003423689', 'ประตูไม้เสียดช่อ 8 ฟัก เป็นไม้สีอ่อน ทำมุมให้มน', 'คำสั่งซื้อสำเร็จ', '2565-01-24', '2565-02-03', 'เงินสด', 'จัดส่งที่บ้านเลขที่ 75/123 หมู่บ้านรวยรวยเฮงเฮง ถนนข้าวสาร กรุงเทพ', '1101003423689'),
('0076587', '1104603408762', 'หน้าต่างไม้พลวง สเปนตรง 6 ช่อง', 'คำสั่งซื้อสำเร็จ', '2565-02-04', '2565-02-14', 'โอนเงิน', 'รับที่ร้าน', '1104603408762'),
('0076593', '1130302343297', 'ประตูไม้จำปาฟักปีกนก ครึ่งบนเป็นไม้สีเข้ม ครึ่งล่างเป็นไม้สีอ่อน', 'คำสั่งซื้อกำลังดำเนินการ', '2565-03-10', '2565-03-10', 'เงินสด', 'จัดส่งที่ อพาร์ทเม้นท์ชะบา ถนนบางรักพัฒนา อำเภอบางบัวทอง จังหวัดนนทบุรี', '1130302343297'),
('0076594', '1130302343297', 'ลูกบันไดไม้ ไม้สัก เกรดA', 'คำสั่งซื้อกำลังดำเนินการ', '2565-03-11', '2565-03-11', 'โอนเงิน', 'จัดส่งที่ อพาร์ทเม้นท์ชะบา ถนนบางรักพัฒนา อำเภอบางบัวทอง จังหวัดนนทบุรี', '1130302343297'),
('0076584', '3100501345403', 'ลูกบันไดไม้สัก', 'คำสั่งซื้อสำเร็จ', '2565-01-10', '2565-01-24', 'เช็ค', 'จัดส่งบ้านเลขที่ 258/145 หมู่บ้านสูงสุดในใจ ถนนเชียงใหม่ จังหวัดเชียงใหม่', '3100501345403'),
('0076585', '3100501345403', 'ประตูไม้สนลาว โมเดิร์น มีช่องขนาด 18 x 18 เซนติเมตร อยู่ที่ด้านล่าง (เอาไว้ให้แมวเข้า)', 'คำสั่งซื้อสำเร็จ', '2565-01-18', '2565-01-25', 'เงินสด', 'จัดส่งบ้านเลขที่ 258/145 หมู่บ้านสูงสุดในใจ ถนนเชียงใหม่ จังหวัดเชียงใหม่', '3100501345403'),
('0076582', '3101501422769', 'วงกบหน้าต่างบาน 3 ช่อง ใช้ไม้สักเท่านั้น เนื้อไม้สีเข้ม', 'คำสั่งซื้อสำเร็จ', '2564-12-20', '2565-01-01', 'เงินสด', 'รับที่ร้าน', '3101501422769'),
('0076583', '3101501422769', 'วงกบหน้าต่างคู่ ไม้แคมปัสเท่านั้น', 'คำสั่งซื้อสำเร็จ', '2565-01-05', '2565-01-12', 'เงินสด', 'จัดส่งที่ อพาร์ทเม้นท์เพ็ญศรี ถนนวิภาวดี จังหวัดปทุมธานี', '3104200763566'),
('0076591', '3101501422769', 'ลูกบันไดไม้สัก ทำตามแบบที่วาดมาเป๊ะๆ เน้นไม้สีอ่อน ทำช่องข้างล่างให้หมาชิวาว่าเข้าได้', 'คำสั่งซื้อสำเร็จ', '2565-03-02', '2565-03-07', 'เช็ค', 'จัดส่งที่บ้านเลขที่ 99 หมู่บ้านยันหว่าง ถนนกิ่งแก้ว ลาดกระบัง กรุงเทพ', '3101501422769'),
('0076589', '3103000989404', 'หน้าต่างไม้สัก บันไดลิง (ขอบ 4)', 'คำสั่งซื้อสำเร็จ', '2565-02-18', '2565-02-25', 'เช็ค', 'จัดส่งที่บ้านเลขที่ 147 หมู่บ้านหงส์ดำ อำเภอเมือง จังหวัดนนทบุรี', '3103000989404'),
('0076581', '3104100909332', 'วงกบประตูไม้แคมปัส', 'คำสั่งซื้อสำเร็จ', '2564-12-15', '2564-12-20', 'โอนเงิน', 'รับที่ร้าน', '3104100909332'),
('0076590', '3130102546754', 'ประตูไม้เสียดช่อ5ลูกฟักใหญ่หนา1นิ้วเสมอขอบ ไม้เสียดช่อเท่านั้น ตัวไม้ต้องสีเข้ม', 'คำสั่งซื้อกำลังดำเนินการ', '2565-02-25', '2565-03-04', 'โอนเงิน', 'จัดส่งที่บ้านเลขที่ 12 หมู่ 4 หมู่บ้านแสนดี ถนนบางรักพัฒนา จังหวัดนนทบุรี', '3130102546754');
